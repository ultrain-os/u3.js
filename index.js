...
const createU3 = (config = {}) => {
    ...
    const CipherSelector = require('./src/cipher-selector');
    // 保证在require其它非系统模块前初始化Cipher
    const Cipher = CipherSelector(config.cipherType ? config.cipherType : configDefaults.cipherType);
