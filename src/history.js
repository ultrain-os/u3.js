 ...
 * const u3 = createU3(config)
 * await u3.getAccountByName('cona1')
 *
 * json structure:
 * {
 ...
 * @memberOf history
 * @example
 * import {getAccountsByKey} from "u3.js";
 * const u3 = createU3(config)
 ...
 * const u3 = createU3(config)
 * await u3.search(5b7d11b859bd97fab30ba7f5)
 */
 ...
 * import {createU3} from "u3.js";
 * const u3 = createU3(config)
 * await u3.getTokenBySymbol("ZTPJ","user.11.111")
 *
 * json structure:
 * {
